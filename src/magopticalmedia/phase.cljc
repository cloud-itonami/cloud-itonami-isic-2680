(ns magopticalmedia.phase
  "Phase 0->3 staged rollout for the magnetic/optical media
  ...
  consequence (a coating/molding/stamping-line-equipment maintenance
  window means production downtime, and the equipment ends up actually
  touched); it is always a human plant supervisor's call.
  `magopticalmedia.governor`'s `equipment-actuate-blocked-violations`
...
(defn verdict->disposition
  "Map a Magnetic and Optical Media Plant Operations Governor verdict
  to a base disposition before the phase gate."
  [verdict]
