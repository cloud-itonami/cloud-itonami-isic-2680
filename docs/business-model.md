# Business Model: Manufacture of magnetic and optical media
...
## Classification
- Repository: `cloud-itonami-isic-2680` ([github.com/cloud-itonami/cloud-itonami-isic-2680](https://github.com/cloud-itonami/cloud-itonami-isic-2680))
- ISIC Rev.5: `2680` — Manufacture of magnetic and optical media
- Domain: `:magnetic-optical-media/manufacturing`
- Social impact: :worker-safety :product-safety :chemical-safety
- Actor: `:magnetic-optical-media-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :magnetic-optical-media/manufacturing — who wants
...
One managed tenant (:magnetic-optical-media/manufacturing):
...
- Do not bypass the `:magnetic-optical-media-plant-operations-governor` for production decisions.
