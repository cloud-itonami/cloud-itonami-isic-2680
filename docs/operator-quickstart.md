# Operator Quickstart — Manufacture of magnetic and optical media

Shortest path from clone to a verified local dry-run for **ISIC 2680** (`cloud-itonami-isic-2680`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2680.git
cd cloud-itonami-isic-2680
```
...
- Blueprint governor key: `magnetic-optical-media-plant-operations-governor`
- Likely source path: `magopticalmedia.governor.cljc`
